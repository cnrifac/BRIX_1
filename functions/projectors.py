...
if (__name__ == '__main__'):
    ...
    slrFile = '/projects/data/afrisar_dlr/'
    grdFile = '/projects/.tiff'
    lutFile = '/projects/data/afrisar_dlr/afrisar_dlr_T2-0_lut.tiff'
    
#    SlrToGrdProj(slrFile, grdFile, azimuthFile, rangeFile)
    
    
    grdFile = '/projects/data/afrisar_dlr/afrisar_dlr_dem_S_T2-0.tiff'
    slrFile2 = '/projects/demSR.tiff'
    
    GrdToSlrProj(grdFile, slrFile2, lutFile, slrFile)
